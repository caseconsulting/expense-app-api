...
/** @typedef {import('../models/employee.js')} Employee */
/** @typedef {import('../models/contract.js')} Contract */
 ...
 * @returns {boolean} Whether employees should be notified today
 */
function isCaseReminderDay(day) {
 ...
 * @param {boolean} isCaseReminderDay Result object of _isCaseReminderDay to check monthly vs weekly
 * @param {Contract[]} contracts Contracts from the Portal
 * @returns {Promise<boolean>} Whether the employee has not met their pay period hours
 */
async function shouldSendCaseEmployeeReminder(employee, isCaseReminderDay, portalContracts) {
...
} // shouldSendCaseEmployeeReminder

/**
 * Gets the QuickBooks access token.
 *
 * @returns {Promise<string>} The QuickBooks access token
 */
